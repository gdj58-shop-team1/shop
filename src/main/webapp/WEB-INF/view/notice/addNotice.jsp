				...
				<form action="${pageContext.request.contextPath}/AddNotice" method="post" id="noticeForm">
					<table class="table stext-110 cl2">
						...
						<tr>
							...
							<td>
								<textarea name="noticeContent" id="noticeContent" rows="10" class="form-control" placeholder="내용을 입력해주세요."></textarea>
							</td>
						</tr>
						<tr>
							...
							<td class="text-right">
								<button type="button" id="noticeBtn" class="stext-101 cl6 size-101 bg2 bor1 hov-btn1">공지추가</button>
							</td>
						</tr>
					</table>
				</form>
